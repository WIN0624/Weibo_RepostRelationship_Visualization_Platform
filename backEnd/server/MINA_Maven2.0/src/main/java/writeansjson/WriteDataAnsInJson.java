...
import MyRedis.ReadDataFromRedis;
...
//
     ...
     * 用于拼接最后返回给前端的字符串
     * */
    public static String getFinalAnswer(String query, String jsonInfo){
        String result = "";
        long page = ReadDataFromRedis.getPageNumber(query);
        result += "[{\"pageCount\":\""+page+"\"},";
        result += jsonInfo.substring(1);
        return result;
    }
